...
void loop(){
  ...
  // Aqui estamos fazendo um para para o servo girar de 15° até 165°
    ...
    Serial.print(".");      // Coloca um '.' depois da distancia for indexar no processing a distancia
    }
    ...
    digitalWrite(trig_Pino, LOW);  // Aqui vou desligar o trigger for poder realizar os pulsos
    delayMicroseconds(2);
    ...
    tempo = pulseIn(echo_Pino, HIGH);  // Aqui setamos o Echo for capitar o pulso ultrassonico && voltar o tempo que ele demorou
    
    distancia = tempo*0.034/2;  // Por fim, esta é a fórmula que utilizamos for converter o tempo na distancia do objeto até o sensor
    return distancia;
}